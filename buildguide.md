...
**参考動画:** [はんだ付けショート動画 (JBC)](https://www.youtube.com/shorts/nPz37an_7ng)
...
**※ ワークショップ参加者の方へ：RGB LED は実装済みのため、このセクションはスキップできます。**

RGB LED は、足の切り欠きとシルクスクリーンの角を合わせた向きにしてください。
...
<span style="color:red">**⚠ 注意：以下写真の赤枠で囲まれたソケットは向きが間違っています（シルク印刷と逆向き）。正しい向きはシルク印刷に合わせてください。**</span>
...
このパーツは高さを合わせるためのものなので、はんだ付け後に回収します。
この高さ合わせ用パーツは、液晶の穴には刺さりません。  
